...
from camel.configs import ChatGPTConfig, QwenConfig, VLLMConfig, OpenRouterConfig, GeminiConfig, DeepSeekConfig
import math
...
def get_agent_config(model_type):
    ...
    elif model_type == 'deepseek-ai/DeepSeek-R1':
        agent_config = {
            'model_type': ModelType.DEEPINFRA_DEEPSEEK_R1,
            'model_platform': ModelPlatformType.DEEPSEEK,
            'model_config': DeepSeekConfig().as_dict(),
        }
